...
DISTRIBUTION_NAME = "nsflow"

# Repo root (nsflow/backend/utils/version.py -> three parents up), for the
...
def resolve_version() -> Tuple[str, str]:
    ...
    then unknown.
    """
    env_version = os.environ.get("NSFLOW_VERSION")
